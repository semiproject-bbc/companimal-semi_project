...
public class RewardOptDTO implements java.io.Serializable {
    ...
    public RewardOptDTO(String rewOptCode, String rewCode, int rewOptNum, String rewOptName, String rewOptVal, int rewOptLimit, int rewAmount) {
